            ...
            <ul class="nav sf-menu clearfix">
                ...
                <li class="sub-menu"><a href="index-1.html">About</a><span></span>
                    <ul class="submenu">
        				...
        				<li><a href="#">Gallery</a><span></span>
                            <ul class="submenu">
                                <li><a href="#">Lorem</a></li>
                                <li><a href="#">Dolor</a></li>
                                <li><a href="#">Sirtower</a></li>
                            </ul> 
                        </li>
        				<li><a href="#">Events</a></li>
        			</ul>
                </li>
                <li><a href="index-2.html">Our classes</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h2 class="indent"><span>Search result:<br><em></em></span></h2>
...
<footer>
    <div class="container">
        ...
        <p>Copyright &copy; <em id="copyright-year"></em> | <a href="index-5.html">Privacy policy</a></p>
    </div>
</footer>
